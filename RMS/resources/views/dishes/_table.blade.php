        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-sm btn-outline-secondary js-edit-dish" data-id="{{ $dish->id }}">Editar</button>
...
<div class="mt-3">{{ $dishes->appends(['search' => $search])->links() }}</div>
