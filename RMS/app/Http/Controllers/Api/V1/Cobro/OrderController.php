...
class OrderController extends Controller
{
    ...
    public function ticket(int $id): Response
    {
        ...
        $pdf = Pdf::loadView('pos.ticket', [
            'order'                => $order,
            // Nombre del negocio para el ticket impreso, no el de config('app.name')
            // (ese es el nombre interno del proyecto Laravel, "Don Pulpo RMS").
            'businessName'         => 'Don Pulpo Mariscos',
